...
${SHIPPING_ONLINE_CREDIT_SECTION_TEXT}    Online Credit
${SHIPPING_ONLINE_CREDIT_CHECK_EXPIRE_DATE_TEXT}    Check Expire Date
${SHIPPING_ONLINE_CREDIT_AVAILABLE_CREDIT_TEXT}    Available Credit    
${SHIPPING_ONLINE_CREDIT_APPLIED_CREDIT_TEXT}    applied credit
${SHIPPING_ONLINE_CREDIT_CC}    Cancel to Use Online Credit


#PAYMENT_PAGE
${PAYMENT_SELECT_PAYMENT_METHOD_TEXT}    Select Payment Method
${CARDHOLDER_NAME}    kittiya QA
${CARD_NUMBER}    4242424242424242
${CARD_NUMBER_INVALID}    4242424242424245
${CARD_NUMBER_ERROR_MESSEGE}    Please enter a valid credit card number. 
${EXPIRATION_MONTH}    1
${EXPIRATION_MONTH_INVALID}    2
${EXPIRATION_YEAR}    2026
${EXPIRATION_YEAR_INVALID}    2027
${CVV}    123       
${CVV_INVALID}    128
...
#PromptPay page
${PROMPTPAY_PAY_WITH_PROMPTPAY}    Pay with PromptPay
${PROMPTPAY_ORDER_NUMBER}    Order Number
${PROMPTPAY_TIMER}    This QR Code Expires in
${PROMPTPAY_MER_NAME_TEXT}    Misty Mynx
${PROMPTPAY_HOW_TO_PAY_TEXT}    How to pay by QR PromptPay